...
| **Dissenter** | Opus | Challenges plans before and after execution | Touch the filesystem or look at actual code |
...
3. [Ollama](https://ollama.com) if you want the Muse (optional but recommended, in the way that coffee is technically optional)
