...
| Dissenter | Model of your choice | 1 | Challenges plans before execution and results before commit. |
...
| Muse | Model of your choice (must differ from other crew models) | 0-1 | Reframes problems, offers lateral perspective. Optional. |
...
The Muse runs on a model distinct from the Claude crew — something with different weights, a different latent space, a genuinely different way of processing the problem. That is the point. It is not smarter than the crew. It sees sideways.
